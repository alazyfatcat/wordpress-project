...
// edit the woocommerce shop pages(single)
...
remove_action ('woocommerce_product_tabs_panel', 'woocommerce_product_reviews_tab', 30);
...
function my_theme_wrapper_start(){echo '<main id="main">';}
function my_theme_wrapper_end(){echo '</main>';}
// add the woocommerce support
...
//create our own post type
function camp_rerview(){
	$labels = array(
			'name'            => ('Camps'),
			'singular_name'   => ('Camp'),
			'menu_name'       => ('Camp Reviews')
		);
		$args = array(
			'label'           => ('camps'),
			'description'     => ('Camp Reviews'),
			'labels'          => $labels,
			'supports'        => array(
					'title',
					'editor',
